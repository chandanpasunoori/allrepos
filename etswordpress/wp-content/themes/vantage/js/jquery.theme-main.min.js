...
jQuery(function($){$('body.no-js').removeClass('no-js');$('.entry-content .flexslider:not(.metaslider .flexslider), #metaslider-demo.flexslider').flexslider({});$('.entry-content, .entry-content .panel').fitVids();if(!vantageSettings.isMobile){$(window).scroll(function(){if($(window).scrollTop()>150)$('#scroll-to-top').addClass('displayed');else $('#scroll-to-top').removeClass('displayed');});$('#scroll-to-top').click(function(){$("html, body").animate({scrollTop:"0px"});return false;});}
